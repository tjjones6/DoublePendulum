...
% Initial Conditions
fidelity = 500;
theta1 = linspace(-pi,-2.8,fidelity);  % Initial angle of the first pendulum (radians)
theta2 = linspace(-0.3,-0.1,fidelity);  % Initial angle of the second pendulum (radians)
